...
function jr(e, t, n, r, l) {
    ...
    if (o)
        ...
        jr(l, t, n, "", function(d) {
            return d
        })) : l != null && (Gi(l) && (l = Mc(l, n + (!l.key || o && o.key === l.key ? "" : ("" + l.key).replace(Ko, "$&/") + "/") + e)),
        t.push(l)),
        1;
    if (o = 0,
    r = r === "" ? "." : r + ":",
...
D.StrictMode = Cc;
D.Suspense = Lc;
D.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Fc;
D.act = au;
...
var Ac = I
  ...
  , Bc = Ac.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner
  , Hc = {
    key: !0,
    ref: !0,
    __self: !0,
...
function cu(e, t, n) {
    ...
    for (r in t)
        Vc.call(t, r) && !Hc.hasOwnProperty(r) && (l[r] = t[r]);
    if (e && e.defaultProps)
...
(function(e) {
    ...
    function r(C) {
        ...
        if (L !== _) {
            C[0] = L;
            e: for (var K = 0, b = C.length, lr = b >>> 1; K < lr; ) {
                var wt = 2 * (K + 1) - 1
                  , Cl = C[wt]
                  , kt = wt + 1
                  , ir = C[kt];
                if (0 > l(Cl, L))
                    kt < b && 0 > l(ir, Cl) ? (C[K] = ir,
                    C[kt] = L,
                    K = kt) : (C[K] = Cl,
                    C[wt] = L,
                    K = wt);
                else if (kt < b && 0 > l(ir, L))
                    C[K] = ir,
                    C[kt] = L,
                    K = kt;
                else
    ...
    function v(C, _) {
        ...
        try {
            for (p(_),
            g = n(a); g !== null && (!(g.expirationTime > _) || C && !ve()); ) {
                var K = g.callback;
                if (typeof K == "function") {
                    g.callback = null,
                    m = g.priorityLevel;
                    var b = K(g.expirationTime <= _);
                    _ = e.unstable_now(),
    ...
    e.unstable_scheduleCallback = function(C, _, L) {
        ...
        L > K ? (C.sortIndex = L,
        t(d, C),
        n(a) === null && C === n(d) && (S ? (f(T),
        T = -1) : S = !0,
        jl(y, L - K))) : (C.sortIndex = b,
        t(a, C),
        k || w || (k = !0,
        Nl(v))),
        C
...
var Ze = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u")
  ...
  , Xo = {};
function Yc(e) {
    return ti.call(Xo, e) ? !0 : ti.call(Yo, e) ? !1 : Kc.test(e) ? Xo[e] = !0 : (Yo[e] = !0,
    !1)
}
function Xc(e, t, n, r) {
    if (n !== null && n.type === 0)
...
function Zc(e, t, n, r) {
    if (t === null || typeof t > "u" || Xc(e, t, n, r))
        return !0;
    if (r)
        return !1;
    if (n !== null)
...
function bi(e, t, n, r) {
    ...
    r || l === null ? Yc(t) && (n === null ? e.removeAttribute(t) : e.setAttribute(t, "" + n)) : l.mustUseProperty ? e[l.propertyName] = n === null ? l.type === 3 ? !1 : "" : n : (t = l.attributeName,
    r = l.attributeNamespace,
    n === null ? e.removeAttribute(t) : (l = l.type,
    n = l === 3 || l === 4 && n === !0 ? "" : "" + n,
    r ? e.setAttributeNS(r, t, n) : e.setAttribute(t, n))))
}
var be = Qc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED
...
function xu(e) {
    ...
    var n = t.getValue()
      , r = "";
    return e && (r = vu(e) ? e.checked ? "true" : "false" : e.value),
    e = r,
    e !== n ? (t.setValue(e),
    !0) : !1
}
...
function si(e, t) {
    ...
    t.hasOwnProperty("value") ? ui(e, t.type, n) : t.hasOwnProperty("defaultValue") && ui(e, t.type, ht(t.defaultValue)),
...
function rd(e, t, n, r, l, i, o, s, a) {
    En = !1,
    Fr = null,
    td.apply(nd, arguments)
}
function ld(e, t, n, r, l, i, o, s, a) {
    if (rd.apply(this, arguments),
    En) {
        if (En) {
            var d = Fr;
            En = !1,
...
var Mu = Ne.unstable_scheduleCallback
  , ns = Ne.unstable_cancelCallback
  , od = Ne.unstable_shouldYield
  , sd = Ne.unstable_requestPaint
  , Y = Ne.unstable_now
  ...
  , ad = Ne.unstable_LowPriority
  , Ru = Ne.unstable_IdlePriority
  , ul = null
  , Be = null;
function cd(e) {
...
var Re = Math.clz32 ? Math.clz32 : pd
  , dd = Math.log
  , fd = Math.LN2;
function pd(e) {
    return e >>>= 0,
    e === 0 ? 32 : 31 - (dd(e) / fd | 0) | 0
}
var cr = 64
  , dr = 4194304;
function Nn(e) {
...
function hd(e, t) {
    for (var n = e.suspendedLanes, r = e.pingedLanes, l = e.expirationTimes, i = e.pendingLanes; 0 < i; ) {
        var o = 31 - Re(i)
          , s = 1 << o
          , a = l[o];
        a === -1 ? (!(s & n) || s & r) && (l[o] = md(s, t)) : a <= t && (e.expiredLanes |= s),
        i &= ~s
    }
}
function yi(e) {
...
var Uu, oo, $u, Vu, Bu, vi = !1, fr = [], st = null, ut = null, at = null, Fn = new Map, An = new Map, rt = [], yd = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
function rs(e, t) {
    switch (e) {
    case "focusin":
    case "focusout":
...
function vd(e, t, n, r, l) {
    ...
    case "dragenter":
        ...
        !0;
    case "mouseover":
        return at = hn(at, e, t, n, r, l),
        !0;
    case "pointerover":
        var i = l.pointerId;
        return Fn.set(i, hn(Fn.get(i) || null, e, t, n, r, l)),
        !0;
    case "gotpointercapture":
        return i = l.pointerId,
        An.set(i, hn(An.get(i) || null, e, t, n, r, l)),
        !0
    }
    return !1
}
...
function gn(e, t) {
    ...
    vi || (vi = !0,
    Ne.unstable_scheduleCallback(Ne.unstable_NormalPriority, xd)))
}
function Un(e) {
    function t(l) {
        return gn(l, e)
...
function Ce(e) {
    function t(n, r, l, i, o) {
        ...
        for (var s in e)
            ...
            this[s] = n ? n(i) : i[s]);
        return this.isDefaultPrevented = (i.defaultPrevented != null ? i.defaultPrevented : i.returnValue === !1) ? pr : is,
...
var dn = {
    ...
    movementX: function(e) {
        return "movementX"in e ? e.movementX : (e !== yn && (yn && e.type === "mousemove" ? (Dl = e.screenX - yn.screenX,
        Il = e.screenY - yn.screenY) : Il = Dl = 0,
        yn = e),
        Dl)
    },
...
var Od = W({}, er, {
  ...
  , Hd = Ce(Bd)
  , Wd = [9, 13, 27, 32]
  , fo = Ze && "CompositionEvent"in window
  , Tn = null;
Ze && "documentMode"in document && (Tn = document.documentMode);
var Qd = Ze && "TextEvent"in window && !Tn
  , Ku = Ze && (!fo || Tn && 8 < Tn && 11 >= Tn)
  , as = " "
  , cs = !1;
function Yu(e, t) {
    switch (e) {
...
function Yd(e, t) {
    if ($t)
        return e === "compositionend" || !fo && Yu(e, t) ? (e = Qu(),
        Tr = uo = it = null,
        $t = !1,
        e) : null;
    switch (e) {
...
function Zu(e, t, n, r) {
    Eu(r),
    t = Hr(t, "onChange"),
    0 < t.length && (n = new ao("onChange","change",null,n,r),
    e.push({
        event: n,
        listeners: t
    }))
...
function ps() {
    _n && (_n.detachEvent("onpropertychange", Ju),
    $n = _n = null)
}
function Ju(e) {
...
function Jd(e, t, n) {
    ...
    _n = t,
    $n = n,
    _n.attachEvent("onpropertychange", Ju)) : e === "focusout" && ps()
}
function qd(e) {
...
var Ae = typeof Object.is == "function" ? Object.is : tf;
function Vn(e, t) {
    if (Ae(e, t))
        return !0;
...
var rf = Ze && "documentMode"in document && 11 >= document.documentMode
  , Vt = null
  , wi = null
  , Pn = null
  , ki = !1;
function gs(e, t, n) {
    ...
    Pn && Vn(Pn, r) || (Pn = r,
    r = Hr(wi, "onSelect"),
    0 < r.length && (t = new ao("onSelect","select",null,t,n),
    e.push({
        event: t,
        listeners: r
    }),
...
var Bt = {
  ...
  , Fl = {}
  , ea = {};
Ze && (ea = document.createElement("div").style,
...
for (var Al = 0; Al < ys.length; Al++) {
    var Ul = ys[Al]
      , lf = Ul.toLowerCase()
      , of = Ul[0].toUpperCase() + Ul.slice(1);
    yt(lf, "on" + of)
}
...
var jn = "abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" ")
  , sf = new Set("cancel close invalid load scroll toggle".split(" ").concat(jn));
function vs(e, t, n) {
...
function Bn(e) {
    if (!e[hr]) {
        ...
        mu.forEach(function(n) {
            n !== "selectionchange" && (sf.has(n) || $l(n, !1, e),
            $l(n, !0, e))
        });
    ...
    Lu(function() {
        ...
        e: {
            ...
            if (m !== void 0) {
                ...
                for (var c = d, p; c !== null; ) {
                    ...
                    f !== null && (y = Rn(c, f),
                    y != null && S.push(Hn(c, y, p)))),
                    O)
                        break;
                    c = c.return
                }
                0 < S.length && (m = new w(m,k,null,n,h),
                g.push({
                    event: m,
                    listeners: S
                }))
        ...
        if (!(t & 7)) {
            e: {
                ...
                m && n !== pi && (k = n.relatedTarget || n.fromElement) && (jt(k) || k[Ge]))
                    break e;
                ...
                w !== k)) {
                    ...
                    f = "onMouseEnter",
                    c = "mouse",
                    (e === "pointerout" || e === "pointerover") && (S = us,
                    y = "onPointerLeave",
                    f = "onPointerEnter",
                    c = "pointer"),
                    O = w == null ? m : Ht(w),
                    p = k == null ? m : Ht(k),
                    m = new S(y,c + "leave",w,n,h),
                    m.target = O,
                    m.relatedTarget = p,
                    y = null,
                    jt(h) === d && (S = new S(f,c + "enter",k,n,h),
                    S.target = p,
                    S.relatedTarget = O,
                    y = S),
                    O = y,
            ...
            e: {
                ...
                w === "select" || w === "input" && m.type === "file")
                    ...
                    (w = m.nodeName) && w.toLowerCase() === "input" && (m.type === "checkbox" || m.type === "radio") && (v = bd);
                if (v && (v = v(e, d))) {
                    Zu(g, v, n, h);
                    break e
                }
                N && N(e, m, d),
                e === "focusout" && (N = m._wrapperState) && N.controlled && m.type === "number" && ui(m, "number", m.value)
            }
            switch (N = d ? Ht(d) : window,
            e) {
            case "focusin":
                (ds(N) || N.contentEditable === "true") && (Vt = N,
                wi = d,
                Pn = null);
                break;
            case "focusout":
            ...
            if (fo)
                ...
                $t ? Yu(e, n) && (T = "onCompositionEnd") : e === "keydown" && n.keyCode === 229 && (T = "onCompositionStart");
            T && (Ku && n.locale !== "ko" && ($t || T !== "onCompositionStart" ? T === "onCompositionEnd" && $t && (E = Qu()) : (it = h,
            uo = "value"in it ? it.value : it.textContent,
            $t = !0)),
            N = Hr(d, T),
            0 < N.length && (T = new ss(T,e,null,n,h),
            g.push({
                event: T,
                listeners: N
            }),
            E ? T.data = E : (E = Xu(n),
            E !== null && (T.data = E)))),
            (E = Qd ? Kd(e, n) : Yd(e, n)) && (d = Hr(d, "onBeforeInput"),
            0 < d.length && (h = new ss("onBeforeInput","beforeinput",null,n,h),
            g.push({
                event: h,
                listeners: d
            }),
...
function xs(e, t, n, r, l) {
    for (var i = t._reactName, o = []; n !== null && n !== r; ) {
        ...
        s.tag === 5 && d !== null && (s = d,
        l ? (a = Rn(n, i),
        a != null && o.unshift(Hn(n, a, s))) : l || (a = Rn(n, i),
        a != null && o.push(Hn(n, a, s)))),
        n = n.return
    }
    o.length !== 0 && e.push({
        event: t,
...
var Ci = typeof setTimeout == "function" ? setTimeout : void 0
  ...
  , df = typeof queueMicrotask == "function" ? queueMicrotask : typeof ks < "u" ? function(e) {
    return ks.resolve(null).then(e).catch(ff)
}
: Ci;
function ff(e) {
    setTimeout(function() {
...
var fn = Math.random().toString(36).slice(2)
  ...
  , Ei = "__reactEvents$" + fn
  , pf = "__reactListeners$" + fn
  , mf = "__reactHandles$" + fn;
function jt(e) {
    var t = e[Ve];
    if (t)
        return t;
...
function ua(e, t, n) {
    ...
    for (var l in r)
        if (!(l in t))
            throw Error(x(108, Jc(e) || "Unknown", l));
    return W({}, n, r)
}
function Kr(e) {
    ...
    if ($) {
        ...
        if (t) {
            ...
            if (!Cs(e, t)) {
                ...
                t = ct(n.nextSibling);
                var r = Se;
                t && Cs(e, t) ? da(r, n) : (e.flags = e.flags & -4097 | 2,
                $ = !1,
                Se = e)
            }
        } else {
...
function yr(e) {
    ...
    e.tag === 13) {
        ...
        ke = Se ? ct(e.stateNode.nextSibling) : null;
    return !0
}
function fa() {
    for (var e = ke; e; )
...
var gf = be.ReactCurrentBatchConfig;
function vn(e, t, n) {
    if (e = n.ref,
...
function pa(e) {
    ...
    function s(f, c, p, y) {
        return c === null || c.tag !== 6 ? (c = Gl(p, f.mode, y),
        c.return = f,
        c) : (c = l(c, p),
        c.return = f,
        c)
    ...
    function a(f, c, p, y) {
        var v = p.type;
        return v === Ut ? h(f, c, p.props.children, y, p.key) : c !== null && (c.elementType === v || typeof v == "object" && v !== null && v.$$typeof === tt && Ts(v) === c.type) ? (y = l(c, p.props),
        y.ref = vn(f, c, p),
        y.return = f,
        y) : (y = Or(p.type, p.key, p.props, null, f.mode, y),
        y.ref = vn(f, c, p),
        y.return = f,
        y)
    }
    function d(f, c, p, y) {
        return c === null || c.tag !== 4 || c.stateNode.containerInfo !== p.containerInfo || c.stateNode.implementation !== p.implementation ? (c = Jl(p, f.mode, y),
        c.return = f,
        c) : (c = l(c, p.children || []),
        c.return = f,
        c)
    }
    function h(f, c, p, y, v) {
        return c === null || c.tag !== 7 ? (c = _t(p, f.mode, y, v),
        c.return = f,
        c) : (c = l(c, p),
        c.return = f,
        c)
    ...
    function m(f, c, p, y) {
        ...
        if (typeof p == "string" && p !== "" || typeof p == "number")
            return v !== null ? null : s(f, c, "" + p, y);
        if (typeof p == "object" && p !== null) {
            switch (p.$$typeof) {
            case sr:
                return p.key === v ? a(f, c, p, y) : null;
            case At:
                return p.key === v ? d(f, c, p, y) : null;
            case tt:
                return v = p._init,
                m(f, c, v(p._payload), y)
            }
            if (Sn(p) || pn(p))
                return v !== null ? null : h(f, c, p, y, null);
            vr(f, p)
        }
        return null
    }
    function w(f, c, p, y, v) {
    ...
    function k(f, c, p, y) {
        for (var v = null, N = null, E = c, T = c = 0, V = null; E !== null && T < p.length; T++) {
            E.index > T ? (V = E,
            E = null) : V = E.sibling;
            var z = m(f, E, p[T], y);
            if (z === null) {
    ...
    function S(f, c, p, y) {
        ...
        p == null)
            throw Error(x(151));
        for (var N = v = null, E = c, T = c = 0, V = null, z = p.next(); E !== null && !z.done; T++,
        z = p.next()) {
            E.index > T ? (V = E,
            E = null) : V = E.sibling;
            var ve = m(f, E, z.value, y);
            if (ve === null) {
                E === null && (E = V);
                break
            }
            e && E && ve.alternate === null && t(f, E),
            c = i(ve, c, T),
            N === null ? v = ve : N.sibling = ve,
            N = ve,
            E = V
        }
        if (z.done)
        ...
        for (E = r(f, E); !z.done; T++,
        z = p.next())
            z = w(E, f, T, z.value, y),
            z !== null && (e && z.alternate !== null && E.delete(z.key === null ? T : z.key),
            c = i(z, c, T),
            N === null ? v = z : N.sibling = z,
            N = z);
                ...
                e: {
                    for (var v = p.key, N = c; N !== null; ) {
                        if (N.key === v) {
                            ...
                            } else if (N.elementType === v || typeof v == "object" && v !== null && v.$$typeof === tt && Ts(v) === N.type) {
                                n(f, N.sibling),
                                c = l(N, p.props),
                                c.ref = vn(f, N, p),
                                c.return = f,
                    ...
                    p.type === Ut ? (c = _t(p.props.children, f.mode, y, p.key),
                    c.return = f,
                    f = c) : (y = Or(p.type, p.key, p.props, null, f.mode, y),
                    y.ref = vn(f, c, p),
                    y.return = f,
                    f = y)
                }
...
function Eo(e, t, n, r, l, i) {
    ...
    t.updateQueue = null,
    t.lanes = 0,
    Lr.current = e === null || e.memoizedState === null ? kf : Sf,
    e = n(r, l),
    Ln) {
        i = 0;
        do {
...
function xa(e, t) {
    ...
    r.getSnapshot !== t || i || ee !== null && ee.memoizedState.tag & 1) {
        if (n.flags |= 2048,
        Zn(9, ka.bind(null, n, r, l, t), void 0, null),
        te === null)
            throw Error(x(349));
        zt & 30 || wa(n, t, l)
    }
...
var el = {
  ...
  , kf = {
    ...
    useImperativeHandle: function(e, t, n) {
        return n = n != null ? n.concat([e]) : null,
        zr(4194308, 4, _a.bind(null, t, e), n)
    },
    ...
    useSyncExternalStore: function(e, t, n) {
        ...
        return l.queue = i,
        zs(Sa.bind(null, r, i, e), [e]),
        r.flags |= 2048,
        Zn(9, ka.bind(null, r, i, n, t), void 0, null),
        n
    },
    useId: function() {
        var e = $e()
...
function Ds(e, t, n, r, l, i, o) {
    ...
    typeof e.shouldComponentUpdate == "function" ? e.shouldComponentUpdate(r, i, o) : t.prototype && t.prototype.isPureReactComponent ? !Vn(n, r) || !Vn(l, i) : !0
}
function Fa(e, t, n) {
    var r = !1
      , l = gt
      , i = t.contextType;
    return typeof i == "object" && i !== null ? i = Le(i) : (l = ge(t) ? Pt : ue.current,
    r = t.contextTypes,
    i = (r = r != null) ? rn(e, l) : gt),
    t = new t(n,i),
...
function Di(e, t, n, r) {
    ...
    ko(e);
    var i = t.contextType;
    typeof i == "object" && i !== null ? l.context = Le(i) : (i = ge(t) ? Pt : ue.current,
    l.context = rn(e, i)),
    l.state = e.memoizedState,
...
function As(e, t, n, r, l) {
    if (e === null) {
        var i = n.type;
        return typeof i == "function" && !Fo(i) && i.defaultProps === void 0 && n.compare === null && n.defaultProps === void 0 ? (t.tag = 15,
        t.type = i,
        $a(e, t, i, r, l)) : (e = Or(n.type, null, r, t, t.mode, l),
        e.ref = t.ref,
        e.return = t,
        t.child = e)
    }
...
function Us(e, t, n, r, l) {
    ...
    t.stateNode === null)
        ...
        var a = o.context
          , d = n.contextType;
        typeof d == "object" && d !== null ? d = Le(d) : (d = ge(n) ? Pt : ue.current,
        d = rn(t, d));
        var h = n.getDerivedStateFromProps
          , g = typeof h == "function" || typeof o.getSnapshotBeforeUpdate == "function";
        g || typeof o.UNSAFE_componentWillReceiveProps != "function" && typeof o.componentWillReceiveProps != "function" || (s !== r || a !== d) && Is(t, o, r, d),
        nt = !1;
        var m = t.memoizedState;
        o.state = m,
        Jr(t, r, o, l),
        a = t.memoizedState,
        s !== r || m !== a || he.current || nt ? (typeof h == "function" && (zi(t, n, h, r),
        a = t.memoizedState),
        (s = nt || Ds(t, n, s, r, m, a, d)) ? (g || typeof o.UNSAFE_componentWillMount != "function" && typeof o.componentWillMount != "function" || (typeof o.componentWillMount == "function" && o.componentWillMount(),
        ...
        m = o.context,
        a = n.contextType,
        typeof a == "object" && a !== null ? a = Le(a) : (a = ge(n) ? Pt : ue.current,
        a = rn(t, a));
        var w = n.getDerivedStateFromProps;
        (h = typeof w == "function" || typeof o.getSnapshotBeforeUpdate == "function") || typeof o.UNSAFE_componentWillReceiveProps != "function" && typeof o.componentWillReceiveProps != "function" || (s !== g || m !== a) && Is(t, o, r, a),
        nt = !1,
        m = t.memoizedState,
        o.state = m,
        Jr(t, r, o, l);
        var k = t.memoizedState;
        s !== g || m !== k || he.current || nt ? (typeof w == "function" && (zi(t, n, w, r),
        k = t.memoizedState),
        (d = nt || Ds(t, n, d, r, m, k, a) || !1) ? (h || typeof o.UNSAFE_componentWillUpdate != "function" && typeof o.componentWillUpdate != "function" || (typeof o.componentWillUpdate == "function" && o.componentWillUpdate(r, k, a),
...
function Oi(e, t, n, r, l, i) {
    ...
    t.child = on(t, null, s, i)) : ae(e, t, s, i),
...
function Wa(e, t, n) {
    ...
    if (i) {
        ...
        r.childLanes = 0,
        r.pendingProps = a,
        t.deletions = null) : (r = mt(l, a),
        r.subtreeFlags = l.subtreeFlags & 14680064),
        s !== null ? i = mt(s, i) : (i = _t(i, o, n, null),
        i.flags |= 2),
        i.return = t,
        r.return = t,
        r.sibling = i,
...
function Ef(e, t, n, r, l, i, o) {
    if (n)
        ...
        r = Xl(Error(x(422))),
        xr(e, t, o, r)) : t.memoizedState !== null ? (t.child = e.child,
        t.flags |= 128,
        null) : (i = r.fallback,
        l = t.mode,
        r = vl({
...
function Tf(e, t, n) {
    ...
    case 13:
        ...
        r !== null)
            ...
            t.flags |= 128,
            null) : n & t.child.childLanes ? Wa(e, t, n) : (F(B, B.current & 1),
            e = qe(e, t, n),
        ...
        for (d in r) {
            ...
            r.hasOwnProperty(d) && a !== s && (a != null || s != null))
                if (d === "style")
                    ...
                    s = s ? s.__html : void 0,
                    a != null && s !== a && (i = i || []).push(d, a)) : d === "children" ? typeof a != "string" && typeof a != "number" || (i = i || []).push(d, "" + a) : d !== "suppressContentEditableWarning" && d !== "suppressHydrationWarning" && (Mn.hasOwnProperty(d) ? (a != null && d === "onScroll" && A("scroll", e),
                    i || s === a || (i = [])) : (i = i || []).push(d, a))
        }
        n && (i = i || []).push("style", n);
        var d = i;
...
function _f(e, t, n) {
            ...
            yr(t)) {
                ...
                for (var o in i)
                    if (i.hasOwnProperty(o)) {
                        ...
                        l = ["children", "" + s]) : Mn.hasOwnProperty(o) && s != null && o === "onScroll" && A("scroll", r)
                    }
                switch (n) {
                case "input":
                    ur(r),
                ...
                e: {
                    ...
                    for (i in s)
                        if (s.hasOwnProperty(i)) {
                            ...
                            a != null && Nu(e, a)) : i === "children" ? typeof a == "string" ? (n !== "textarea" || a !== "") && On(e, a) : typeof a == "number" && On(e, "" + a) : i !== "suppressContentEditableWarning" && i !== "suppressHydrationWarning" && i !== "autoFocus" && (Mn.hasOwnProperty(i) ? a != null && i === "onScroll" && A("scroll", e) : a != null && bi(e, i, a, o))
                        }
                    switch (n) {
                    case "input":
                        ur(e),
    ...
    case 13:
        ...
        t.mode & 1 && (e === null || B.current & 1 ? q === 0 && (q = 3) : Ro())),
        ...
        o === null)
            ...
            if (!r)
                ...
                e !== null) {
                    ...
                    2 * Y() - i.renderingStartTime > an && n !== 1073741824 && (t.flags |= 128,
                    r = !0,
                    xn(i, !1),
                    t.lanes = 4194304);
            ...
            e: {
                ...
                if (r && r.rangeCount !== 0) {
                    ...
                    var o = 0
                      ...
                      , m = null;
                    t: for (; ; ) {
                        for (var w; g !== n || l !== 0 && g.nodeType !== 3 || (s = o + l),
                        ...
                        case 1:
                            if (k !== null) {
                                var S = k.memoizedProps
                                  , O = k.memoizedState
                                  , f = t.stateNode
                                  , c = f.getSnapshotBeforeUpdate(t.elementType === t.type ? S : Ie(t.type, S), O);
...
function qa(e, t) {
            ...
            a !== null)
                try {
                    ...
                    for (o = 0; o < a.length; o += 2) {
                        var h = a[o]
                          , g = a[o + 1];
                        h === "style" ? Cu(l, g) : h === "dangerouslySetInnerHTML" ? Nu(l, g) : h === "children" ? On(l, g) : bi(l, h, g, d)
                    }
                    switch (s) {
                    case "input":
                        si(l, i);
                    ...
                    case "select":
                        ...
                        var w = i.value;
                        w != null ? Gt(l, !!i.multiple, w, !1) : m !== !!i.multiple && (i.defaultValue != null ? Gt(l, !!i.multiple, i.defaultValue, !0) : Gt(l, !!i.multiple, i.multiple ? [] : "", !1))
                    }
                    l[Wn] = i
                } catch (S) {
                    Q(e, e.return, S)
    ...
    case 13:
        ...
        !i || l.alternate !== null && l.alternate.memoizedState !== null || (Io = Y())),
        r & 4 && Ws(e);
        break;
    case 22:
            ...
            if (!o) {
                ...
                (se = a) && !d)
                    for (j = l; j !== null; )
                        o = j,
                        a = o.child,
                        o.tag === 22 && o.memoizedState !== null ? Ys(l) : a !== null ? (a.return = o,
                        j = a) : Ys(l);
                for (; i !== null; )
                    j = i,
                    ba(i),
...
var If = Math.ceil
  ...
  , Mr = 0;
function ce() {
    return M & 6 ? Y() : Ir !== -1 ? Ir : Ir = Y()
}
function pt(e) {
    return e.mode & 1 ? M & 2 && re !== 0 ? re & -re : gf.transition !== null ? (Mr === 0 && (Mr = Fu()),
    Mr) : (e = R,
    e !== 0 || (e = window.event,
...
function Fe(e, t, n, r) {
    if (50 < In)
        ...
        Error(x(185));
    bn(e, n, r),
    (!(M & 2) || e !== te) && (e === te && (!(M & 2) && (yl |= n),
    q === 4 && lt(e, re)),
    ye(e, r),
    n === 1 && M === 0 && !(t.mode & 1) && (an = Y() + 500,
    pl && xt()))
}
function ye(e, t) {
    ...
    e.callbackPriority !== t) {
        if (n != null && ns(n),
        t === 1)
            e.tag === 0 ? hf(Xs.bind(null, e)) : aa(Xs.bind(null, e)),
            df(function() {
                !(M & 6) && xt()
            }),
            n = null;
        ...
        if (t === 6)
            ...
            case 3:
                ...
                10 < t)) {
                    ...
                    e.timeoutHandle = Ci(Nt.bind(null, e, pe, We), t);
                    break
                }
                Nt(e, pe, We);
                break;
            case 4:
                ...
                if (r = l,
                r = Y() - r,
                r = (120 > r ? 120 : 480 > r ? 480 : 1080 > r ? 1080 : 1920 > r ? 1920 : 3e3 > r ? 3e3 : 4320 > r ? 4320 : 1960 * If(r / 1960)) - r,
                10 < r) {
                    e.timeoutHandle = Ci(Nt.bind(null, e, pe, We), r);
                    break
                }
                Nt(e, pe, We);
                break;
...
function Ro() {
    (q === 0 || q === 3 || q === 2) && (q = 4),
    te === null || !(Dt & 268435455) && !(yl & 268435455) || lt(te, re)
}
function ll(e, t) {
    var n = M;
    M |= 2;
...
function Af(e, t, n) {
    ...
    te === e && (re & n) === n && (q === 4 || q === 3 && (re & 130023424) === re && 500 > Y() - Io ? Tt(e, 0) : Do |= n),
    ye(e, t)
}
function ic(e, t) {
    t === 0 && (e.mode & 1 ? (t = dr,
    dr <<= 1,
    !(dr & 130023424) && (dr = 4194304)) : t = 1);
    var n = ce();
    e = Je(e, t),
    e !== null && (bn(e, t, n),
    ye(e, n))
...
oc = function(e, t, n) {
    if (e !== null)
        ...
        me = !1,
        $ && t.flags & 1048576 && ca(t, Xr, t.index);
    switch (t.lanes = 0,
    t.tag) {
    case 2:
        var r = t.type;
    ...
    case 4:
        ...
        r = t.pendingProps,
        e === null ? t.child = on(t, null, r, n) : ae(e, t, r, n),
        t.child;
    case 11:
        return r = t.type,
        l = t.pendingProps,
...
function ac(e, t, n, r, l, i, o, s, a) {
    return e = Ao(n, r, !0, e, l, i, o, s, a),
    e.context = uc(null),
    n = e.current,
    r = ce(),
    l = pt(n),
...
wl.prototype.render = $o.prototype.render = function(e) {
...
;
wl.prototype.unmount = $o.prototype.unmount = function() {
...
var Yf = {
  ...
  , Xf = {
    ...
    findFiberByHostInstance: wn.findFiberByHostInstance || Qf,
...
je.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Yf;
...
const Jf = e => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase().trim()
  , Z = (e, t) => {
    const n = I.forwardRef( ({color: r="currentColor", size: l=24, strokeWidth: i=2, absoluteStrokeWidth: o, className: s="", children: a, ...d}, h) => I.createElement("svg", {
        ref: h,
        ...Gf,
        width: l,
        height: l,
        ...
        className: ["lucide", `lucide-${Jf(e)}`, s].join(" "),
        ...d
    }, [...t.map( ([g,m]) => I.createElement(g, m)), ...Array.isArray(a) ? a : [a]]));
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const qf = Z("ArrowDownWideNarrow", [["path", {
    d: "m3 16 4 4 4-4",
    key: "1co6wj"
}], ["path", {
    d: "M7 20V4",
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const bf = Z("ArrowUpNarrowWide", [["path", {
    d: "m3 8 4-4 4 4",
    key: "11wl7u"
}], ["path", {
    d: "M7 4v16",
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const gc = Z("TrendingUp", [["polyline", {
...
const yc = Z("X", [["path", {
  ...
  , bl = "task_tracker_token"
  , ei = "task_tracker_user";
class dp {
    constructor() {
        this.listeners = []
    }
    login(t, n) {
        return new Promise( (r, l) => {
            setTimeout( () => {
                if (cp[t] === n) {
                    const i = Jn.find(o => o.username === t);
                    if (i) {
                        const o = this.generateMockToken(i);
                        localStorage.setItem(bl, o),
                        ...
                        l(new Error("User not found"))
                } else
                    l(new Error("Invalid credentials"))
            }
            , 1e3)
        }
        )
    ...
    getToken() {
        return localStorage.getItem(bl)
    }
    isAuthenticated() {
    ...
    generateMockToken(t) {
        return `mock_token_${t.id}_${Date.now()}`
    }
    notifyListeners() {
...
const Ft = new dp
    ...
    const [t,n] = I.useState("")
      ...
      , d = async m => {
        ...
        try {
            ...
            o(w instanceof Error ? w.message : "Login failed")
        } finally {
            a(!1)
        }
    }
        ...
        children: u.jsxs("div", {
            ...
            children: [u.jsxs("div", {
                ...
                children: [u.jsx("h3", {
                    ...
                    children: "Click on any account to auto-fill credentials:"
                }), u.jsx("div", {
                    className: "space-y-2",
                    children: h.map(m => u.jsx("button", {
                        onClick: () => g(m.username),
                        ...
                        children: u.jsxs("div", {
                            ...
                            children: [u.jsxs("div", {
                                ...
                                className: `px-2 py-1 text-xs rounded-full ${m.role === "Manager" ? "bg-orange-100 text-orange-800" : "bg-blue-100 text-blue-800"}`,
                                children: m.role
                            })]
                        })
                    }, m.username))
                    ...
                    children: ["Default password for all accounts: ", u.jsx("code", {
  ...
  , Nr = "task_tracker_tasks";
class pp {
    constructor() {
        this.listeners = [],
        localStorage.getItem(Nr) || localStorage.setItem(Nr, JSON.stringify(ap))
    }
    getTasks() {
    ...
    saveTasks(t) {
        localStorage.setItem(Nr, JSON.stringify(t)),
        this.notifyListeners()
    }
    getAllTasks(t, n) {
        return new Promise(r => {
            setTimeout( () => {
                let l = this.getTasks();
                if (t && (t.status && (l = l.filter(i => i.status === t.status)),
                t.priority && (l = l.filter(i => i.priority === t.priority)),
                t.assigneeId && (l = l.filter(i => i.assigneeId === t.assigneeId)),
                t.search)) {
                    const i = t.search.toLowerCase();
                    l = l.filter(o => o.title.toLowerCase().includes(i) || o.description.toLowerCase().includes(i))
                }
                n && l.sort( (i, o) => {
                    let s = i[n.field]
                      , a = o[n.field];
                    ...
                    return (n.field === "dueDate" || n.field === "createdAt") && (s = new Date(s).getTime(),
                    a = new Date(a).getTime()),
                    s < a ? n.direction === "asc" ? -1 : 1 : s > a ? n.direction === "asc" ? 1 : -1 : 0
                }
                ),
                r(l)
            }
    ...
    getTaskById(t) {
        return new Promise(n => {
            setTimeout( () => {
                const l = this.getTasks().find(i => i.id === t) || null;
                n(l)
            }
            , 200)
        }
    ...
    createTask(t) {
        return new Promise(n => {
            setTimeout( () => {
                const r = this.getTasks()
                  , l = Jn.find(o => o.id === t.assigneeId)
                  , i = {
                    ...t,
                    id: Date.now().toString(),
                    assigneeName: (l == null ? void 0 : l.name) || "Unknown",
    ...
    updateTask(t, n) {
        return new Promise( (r, l) => {
            setTimeout( () => {
                ...
                if (n.assigneeId) {
                    const a = Jn.find(d => d.id === n.assigneeId);
                    s.assigneeName = (a == null ? void 0 : a.name) || "Unknown"
                }
                i[o] = s,
                this.saveTasks(i),
                r(s)
    ...
    deleteTask(t) {
        return new Promise( (n, r) => {
            setTimeout( () => {
                const l = this.getTasks()
                  , i = l.findIndex(o => o.id === t);
                if (i === -1) {
    ...
    getDashboardStats(t) {
        return new Promise(n => {
            setTimeout( () => {
                let r = this.getTasks();
                t && (r = r.filter(g => g.assigneeId === t));
                const l = new Date
                  , i = r.filter(g => new Date(g.dueDate) < l && g.status !== "completed").length
                  , o = r.reduce( (g, m) => (g[m.priority]++,
                g), {
                    low: 0,
                    medium: 0,
                    high: 0
                })
                  , s = r.reduce( (g, m) => (g[m.assigneeName] = (g[m.assigneeName] || 0) + 1,
                g), {})
                  , a = r.filter(g => g.status === "completed").length
                  , d = r.length > 0 ? a / r.length * 100 : 0
                  , h = {
                    totalTasks: r.length,
                    completedTasks: a,
                    pendingTasks: r.filter(g => g.status === "pending").length,
                    inProgressTasks: r.filter(g => g.status === "in-progress").length,
                    overdueTasks: i,
                    tasksByPriority: o,
                    tasksByAssignee: s,
                    completionRate: d
...
const we = new pp
  , vc = ({task: e, onStatusChange: t, onEdit: n, onDelete: r, canEdit: l, canDelete: i}) => {
    const o = {
      ...
      , d = g => new Date(g).toLocaleDateString("en-US", {
        month: "short",
        day: "numeric",
        year: "numeric"
    })
      , h = () => new Date(e.dueDate) < new Date && e.status !== "completed";
    return u.jsx("div", {
        className: `bg-white rounded-xl shadow-sm border-2 transition-all duration-200 hover:shadow-md ${h() ? "border-red-200 bg-red-50/30" : "border-gray-100"}`,
        children: u.jsxs("div", {
            className: "p-6",
            children: [u.jsxs("div", {
                ...
                children: [u.jsxs("div", {
                    ...
                    className: `px-3 py-1 rounded-full text-xs font-medium border ${a[e.priority]}`,
                    children: [u.jsx(rp, {
                        className: `inline h-3 w-3 mr-1 ${s[e.priority]}`
                    }), u.jsx("span", {
                        className: s[e.priority],
                        children: e.priority.charAt(0).toUpperCase() + e.priority.slice(1)
                    })]
                })]
            }), u.jsxs("div", {
                ...
                children: [u.jsxs("div", {
                    ...
                    children: [u.jsxs("div", {
                        ...
                        children: [u.jsx(Ho, {
                            ...
                            children: e.assigneeName
                        })]
                    }), u.jsxs("div", {
                        className: `flex items-center gap-2 ${h() ? "text-red-600" : ""}`,
                        children: [u.jsx(mc, {
                            className: "h-4 w-4"
                        }), u.jsx("span", {
                            children: d(e.dueDate)
                        }), h() && u.jsx("span", {
                    ...
                    children: [u.jsx(Bo, {
                        ...
                        children: ["Updated ", d(e.updatedAt)]
                    })]
                })]
            }), u.jsxs("div", {
                ...
                children: [u.jsxs("div", {
                    ...
                    children: [u.jsx("span", {
                        ...
                        value: e.status,
                        onChange: g => t(e.id, g.target.value),
                        className: `px-3 py-1 rounded-full text-xs font-medium border cursor-pointer ${o[e.status]} hover:opacity-80 transition-opacity`,
  ...
  , mp = ({task: e, isOpen: t, onClose: n, onSubmit: r, isManager: l}) => {
    const [i,o] = I.useState({
        title: "",
        description: "",
        status: "pending",
        priority: "medium",
    ...
    const d = async m => {
        ...
        try {
            ...
            console.error("Error submitting task:", w)
        } finally {
            a(!1)
        }
    }
      , h = m => {
        const {name: w, value: k} = m.target;
        o(S => ({
            ...S,
            [w]: k
        }))
    ...
    if (!t)
        return null;
    const g = Jn.filter(m => m.role === "employee");
    return u.jsx("div", {
        ...
        children: u.jsxs("div", {
            ...
            children: [u.jsxs("div", {
                ...
                children: [u.jsx("h2", {
                    ...
                    children: e ? "Edit Task" : "Create New Task"
                }), u.jsx("button", {
                    onClick: n,
                ...
                children: [u.jsxs("div", {
                    ...
                    children: [u.jsxs("div", {
                        ...
                        children: [u.jsx("label", {
                            htmlFor: "assigneeId",
                            className: "block text-sm font-medium text-gray-700 mb-2",
                            children: l ? "Assign to *" : "Assigned to"
                        }), u.jsxs("select", {
                            id: "assigneeId",
                            name: "assigneeId",
                            value: i.assigneeId,
  ...
  , xc = ({filters: e, sort: t, onFiltersChange: n, onSortChange: r, isManager: l}) => {
    const i = Jn.filter(h => h.role === "employee")
      , o = (h, g) => {
        n({
            ...e,
            [h]: g || void 0
      ...
      , s = h => {
        r({
            field: h,
            direction: t.field === h && t.direction === "asc" ? "desc" : "asc"
        })
    }
      , a = () => {
        n({})
    }
      , d = Object.values(e).some(h => h !== void 0 && h !== "");
    return u.jsxs("div", {
        ...
        children: [u.jsxs("div", {
            ...
            children: [u.jsx(sp, {
                ...
                value: e.search || "",
                onChange: h => o("search", h.target.value),
            ...
            children: [u.jsxs("div", {
                ...
                children: [u.jsx(np, {
                    ...
                    value: e.status || "",
                    onChange: h => o("status", h.target.value),
                ...
                children: u.jsxs("select", {
                    value: e.priority || "",
                    onChange: h => o("priority", h.target.value),
                    className: "px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent",
                    children: [u.jsx("option", {
                        value: "",
                ...
                children: u.jsxs("select", {
                    value: e.assigneeId || "",
                    onChange: h => o("assigneeId", h.target.value),
                    className: "px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent",
                    children: [u.jsx("option", {
                        value: "",
                        children: "All Employees"
                    }), i.map(h => u.jsx("option", {
                        value: h.id,
                        children: h.name
                    }, h.id))]
                })
                ...
                children: [u.jsx("span", {
                    ...
                    field: "title",
                    label: "Title"
                }].map( ({field: h, label: g}) => u.jsxs("button", {
                    onClick: () => s(h),
                    className: `px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-1 ${t.field === h ? "bg-blue-100 text-blue-800 border border-blue-200" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`,
                    children: [g, t.field === h && (t.direction === "asc" ? u.jsx(bf, {
                        className: "h-3 w-3"
                    }) : u.jsx(qf, {
                        className: "h-3 w-3"
                    }))]
  ...
  , wc = ({stats: e}) => {
    ...
    return u.jsx("div", {
        ...
        children: t.map( (n, r) => u.jsxs("div", {
            className: `${n.bgColor} rounded-xl border border-gray-200 p-6 transition-all duration-200 hover:scale-105`,
            children: [u.jsxs("div", {
                className: "flex items-center justify-between",
                children: [u.jsxs("div", {
                    children: [u.jsx("p", {
                        className: `text-sm font-medium ${n.textColor} mb-1`,
                        children: n.title
                    }), u.jsx("p", {
                    ...
                    className: `p-3 rounded-lg ${n.color}`,
                    children: u.jsx(n.icon, {
                        className: "h-6 w-6 text-white"
                    })
                })]
            }), n.title === "Completed" && e.totalTasks > 0 && u.jsxs("div", {
                className: "mt-4",
                children: [u.jsxs("div", {
                    className: "flex items-center justify-between text-sm",
                    children: [u.jsx("span", {
                        className: n.textColor,
                        children: "Completion Rate"
                    }), u.jsxs("span", {
                        className: "font-medium text-gray-900",
                        children: [Math.round(e.completionRate), "%"]
                    })]
                }), u.jsx("div", {
                    className: "mt-2 bg-gray-200 rounded-full h-2",
                    children: u.jsx("div", {
                        className: `h-2 rounded-full transition-all duration-500 ${n.color}`,
                        style: {
  ...
  , ol = ({data: e, type: t, title: n}) => {
    if (t === "bar") {
        const r = Math.max(...e.map(l => l.value));
        return u.jsxs("div", {
                    ...
                    children: [u.jsx("div", {
                        ...
                        children: u.jsx("div", {
                            ...
                            style: {
                                ...
                                width: `${l.value / r * 100}%`,
                                minWidth: l.value > 0 ? "2rem" : "0"
                            },
                            children: l.value > 0 && l.value
                        })
                    })]
                }, i))
            })]
    ...
    if (t === "pie") {
        const r = e.reduce( (i, o) => i + o.value, 0);
        let l = 0;
        return u.jsxs("div", {
            className: "bg-white rounded-xl border border-gray-200 p-6",
            children: [u.jsx("h3", {
                ...
                children: [u.jsxs("div", {
                    ...
                    children: e.map( (i, o) => u.jsxs("div", {
                        ...
                        children: [u.jsx("div", {
                            ...
                            children: [i.name, ": ", i.value, " (", r > 0 ? Math.round(i.value / r * 100) : 0, "%)"]
                        })]
                    }, o))
                })]
            })]
  ...
  , kc = ({user: e, onLogout: t}) => u.jsx("header", {
    ...
    children: u.jsxs("div", {
        ...
        children: [u.jsxs("div", {
            ...
            children: [u.jsxs("div", {
                ...
                children: [u.jsx("div", {
                    className: `p-2 rounded-full ${e.role === "manager" ? "bg-orange-100" : "bg-blue-100"}`,
                    children: u.jsx(Ho, {
                        className: `h-4 w-4 ${e.role === "manager" ? "text-orange-600" : "text-blue-600"}`
                    })
                }), u.jsxs("div", {
                    children: [u.jsx("div", {
                        ...
                        className: `text-xs px-2 py-1 rounded-full ${e.role === "manager" ? "bg-orange-100 text-orange-800" : "bg-blue-100 text-blue-800"}`,
  ...
  , hp = ({user: e, onLogout: t}) => {
    ...
    const c = async () => {
        try {
            const [P,G] = await Promise.all([we.getAllTasks(m, k), we.getDashboardStats()]);
            r(P),
            i(G)
        } catch (P) {
      ...
      , p = async () => {
        try {
            const P = await we.getAllTasks(m, k);
            r(P)
        } catch (P) {
            console.error("Error loading tasks:", P)
        }
    }
      , y = async P => {
        try {
            await we.createTask(P),
            c()
        } catch (G) {
            console.error("Error creating task:", G)
        }
    }
      , v = async P => {
        if (h)
            try {
                await we.updateTask(h.id, P),
                g(null),
                c()
            } catch (G) {
                console.error("Error updating task:", G)
            }
    }
      , N = async (P, G) => {
        try {
            await we.updateTask(P, {
                status: G
            }),
            c()
        } catch (rr) {
            console.error("Error updating task status:", rr)
        }
    }
      , E = async P => {
        if (confirm("Are you sure you want to delete this task?"))
            try {
                await we.deleteTask(P),
                c()
            } catch (G) {
                console.error("Error deleting task:", G)
            }
    }
      , T = P => {
        g(P),
    ...
    const z = l ? [{
        name: "High",
        value: l.tasksByPriority.high,
        color: "#EF4444"
    }, {
        name: "Medium",
        value: l.tasksByPriority.medium,
        color: "#F59E0B"
    }, {
        name: "Low",
        value: l.tasksByPriority.low,
        color: "#10B981"
    }] : []
      , ve = l ? Object.entries(l.tasksByAssignee).map( ([P,G]) => ({
        name: P,
        value: G,
        ...
        children: [u.jsx(kc, {
            ...
            children: [u.jsxs("div", {
                ...
                children: [u.jsxs("button", {
                    onClick: () => f("dashboard"),
                    className: `px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2 ${O === "dashboard" ? "bg-blue-600 text-white" : "bg-white text-gray-600 hover:text-gray-900 border border-gray-200"}`,
                    children: [u.jsx(ep, {
                        className: "h-4 w-4"
                    }), "Analytics Dashboard"]
                }), u.jsxs("button", {
                    onClick: () => f("tasks"),
                    className: `px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2 ${O === "tasks" ? "bg-blue-600 text-white" : "bg-white text-gray-600 hover:text-gray-900 border border-gray-200"}`,
                    children: [u.jsx(mc, {
                        className: "h-4 w-4"
                    }), "Task Management"]
                })]
            }), O === "dashboard" && l && u.jsxs("div", {
                className: "space-y-6",
                children: [u.jsx(wc, {
                    stats: l
                }), u.jsxs("div", {
                    ...
                    children: [u.jsxs("div", {
                        ...
                        className: "space-y-4",
                        children: n.slice(0, 5).map(P => u.jsxs("div", {
                            ...
                            children: [u.jsxs("div", {
                                children: [u.jsx("h4", {
                                    ...
                                    className: "text-sm text-gray-600",
                                    children: ["Assigned to ", P.assigneeName]
                                })]
                            }), u.jsxs("div", {
                                className: "flex items-center gap-3",
                                children: [u.jsx("span", {
                                    className: `px-2 py-1 text-xs rounded-full ${P.status === "completed" ? "bg-green-100 text-green-800" : P.status === "in-progress" ? "bg-blue-100 text-blue-800" : "bg-yellow-100 text-yellow-800"}`,
                                    children: P.status.replace("-", " ")
                                }), u.jsx("span", {
                                    className: `px-2 py-1 text-xs rounded-full ${P.priority === "high" ? "bg-red-100 text-red-800" : P.priority === "medium" ? "bg-yellow-100 text-yellow-800" : "bg-green-100 text-green-800"}`,
                                    children: P.priority
                                })]
                            })]
                        }, P.id))
                ...
                children: [u.jsxs("div", {
                    ...
                    children: [u.jsxs("div", {
                        ...
                        children: [u.jsx(bs, {
                            ...
                            children: [u.jsx("h2", {
                                ...
                                className: "text-sm text-gray-600",
                                children: "Manage and assign tasks to your team"
                            })]
                        })]
                    }), u.jsxs("button", {
                        onClick: () => d(!0),
                        className: "px-4 py-2 bg-gradient-to-r from-blue-600 to-teal-600 text-white rounded-lg font-medium hover:from-blue-700 hover:to-teal-700 transition-all duration-200 flex items-center gap-2",
                        children: [u.jsx(hc, {
                            className: "h-4 w-4"
                        }), "Create Task"]
                    })]
                    ...
                    children: [u.jsx(bs, {
                        ...
                        children: "Create your first task to get started with team management."
                    }), u.jsx("button", {
                        onClick: () => d(!0),
                        className: "px-4 py-2 bg-gradient-to-r from-blue-600 to-teal-600 text-white rounded-lg font-medium hover:from-blue-700 hover:to-teal-700 transition-all duration-200",
  ...
  , gp = ({user: e, onLogout: t}) => {
    const [n,r] = I.useState([])
      ...
      , [m,w] = I.useState("dashboard");
    I.useEffect( () => {
        k();
        const v = setInterval(k, 3e4)
          , N = we.subscribe(k);
        return () => {
            clearInterval(v),
            N()
    ...
    const k = async () => {
        try {
            const v = {
              ...
              , [N,E] = await Promise.all([we.getAllTasks(v, h), we.getDashboardStats(e.id)]);
            r(N),
            i(E)
        } catch (v) {
            console.error("Error loading data:", v)
        } finally {
            s(!1)
        }
    }
      , S = async () => {
        try {
            const v = {
              ...
              , N = await we.getAllTasks(v, h);
            r(N)
        } catch (v) {
            console.error("Error loading tasks:", v)
        }
    }
      , O = async (v, N) => {
        try {
            await we.updateTask(v, {
                status: N
            }),
            k()
        } catch (E) {
    ...
    const c = l ? [{
      ...
      , p = l ? [{
        name: "Pending",
        value: l.pendingTasks,
        color: "#F59E0B"
    }, {
        name: "In Progress",
        value: l.inProgressTasks,
        color: "#3B82F6"
    }, {
        name: "Completed",
        value: l.completedTasks,
        color: "#10B981"
    }] : []
      , y = n.filter(v => v.status !== "completed" && new Date(v.dueDate) > new Date).sort( (v, N) => new Date(v.dueDate).getTime() - new Date(N.dueDate).getTime()).slice(0, 5);
    return u.jsxs("div", {
        className: "min-h-screen bg-gray-50",
        children: [u.jsx(kc, {
            user: e,
            ...
            children: [u.jsxs("div", {
                ...
                children: [u.jsxs("button", {
                    onClick: () => w("dashboard"),
                    className: `px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2 ${m === "dashboard" ? "bg-blue-600 text-white" : "bg-white text-gray-600 hover:text-gray-900 border border-gray-200"}`,
                    children: [u.jsx(gc, {
                        className: "h-4 w-4"
                    }), "My Progress"]
                }), u.jsxs("button", {
                    onClick: () => w("tasks"),
                    className: `px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2 ${m === "tasks" ? "bg-blue-600 text-white" : "bg-white text-gray-600 hover:text-gray-900 border border-gray-200"}`,
                    children: [u.jsx(ql, {
                        className: "h-4 w-4"
                    }), "My Tasks"]
                })]
            }), m === "dashboard" && l && u.jsxs("div", {
                className: "space-y-6",
                children: [u.jsx(wc, {
                    stats: l
                }), u.jsxs("div", {
                    ...
                    children: [u.jsxs("div", {
                        ...
                        className: "space-y-4",
                        children: y.length > 0 ? y.map(v => u.jsxs("div", {
                            className: "flex items-center justify-between p-4 bg-gray-50 rounded-lg",
                            children: [u.jsxs("div", {
                                className: "flex-1",
                                children: [u.jsx("h4", {
                                    ...
                                    children: ["Due: ", new Date(v.dueDate).toLocaleDateString()]
                                })]
                            }), u.jsxs("div", {
                                className: "flex items-center gap-3",
                                children: [u.jsx("span", {
                                    className: `px-2 py-1 text-xs rounded-full ${v.status === "in-progress" ? "bg-blue-100 text-blue-800" : "bg-yellow-100 text-yellow-800"}`,
                                    children: v.status.replace("-", " ")
                                }), u.jsx("span", {
                                    className: `px-2 py-1 text-xs rounded-full ${v.priority === "high" ? "bg-red-100 text-red-800" : v.priority === "medium" ? "bg-yellow-100 text-yellow-800" : "bg-green-100 text-green-800"}`,
                                    children: v.priority
                                })]
                            })]
                        }, v.id)) : u.jsxs("div", {
                ...
                children: [u.jsxs("div", {
                    ...
                    children: [u.jsx(ql, {
                        ...
                        children: [u.jsx("h2", {
                            ...
                            className: "text-sm text-gray-600",
                            children: "Track and update your assigned tasks"
                        })]
                    })]
                }), u.jsx(xc, {
                    filters: a,
                    ...
                    children: [u.jsx(ql, {
                        ...
                        className: "text-gray-600",
                        children: "You don't have any tasks assigned yet. Check back later or contact your manager."
                    })]
                })]
            })]
        })]
...
function yp() {
    const [e,t] = I.useState({
      ...
      , [n,r] = I.useState(!0);
    I.useEffect( () => {
        const o = Ft.getAuthState();
        return t(o),
        r(!1),
        Ft.subscribe( () => {
            const a = Ft.getAuthState();
            t(a)
        }
        )
    }
    ...
    }) : !e.isAuthenticated || !e.user ? u.jsx(fp, {
        onLogin: l
    }) : e.user.role === "manager" ? u.jsx(hp, {
        user: e.user,
        onLogout: i
    }) : u.jsx(gp, {
        user: e.user,
...
fc(document.getElementById("root")).render(u.jsx(I.StrictMode, {
    children: u.jsx(yp, {})
}));
